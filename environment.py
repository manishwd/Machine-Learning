...
class Environment(object):
    ...
    def reset(self):
        ...
        for traffic_light in list(self.intersections.values()):
            traffic_light.reset()
    ...
    def step(self):
        ...
        for intersection, traffic_light in list(self.intersections.items()):
    ...
    def sense(self, agent):
        ...
        left = None
        right = None
        for other_agent, other_state in list(self.agent_states.items()):
